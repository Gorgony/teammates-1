...
public class AdminAccountDeleteAction extends Action {
    ...
    protected ActionResult execute() {
        ...
        String studentId = getRequestParamValue(ParamNameConst.ParamsNames.STUDENT_ID);
    ...
    private ActionResult removeInstructorFromCourse(String instructorId, String courseId) {
        ...
        statusToUser.add(new StatusMessage(StatusMessageConst.StatusMessages.INSTRUCTOR_REMOVED_FROM_COURSE, StatusMessageColor.SUCCESS));
    ...
    private ActionResult removeStudentFromCourse(String instructorId, String courseId, String studentId) {
        ...
        statusToUser.add(new StatusMessage(StatusMessageConst.StatusMessages.STUDENT_DELETED,
    ...
    private ActionResult deleteInstructorAccount(String instructorId) {
        ...
        statusToUser.add(new StatusMessage(StatusMessageConst.StatusMessages.INSTRUCTOR_ACCOUNT_DELETED, StatusMessageColor.SUCCESS));
    ...
    private ActionResult deleteInstructorStatus(String instructorId) {
        ...
        statusToUser.add(new StatusMessage(StatusMessageConst.StatusMessages.INSTRUCTOR_STATUS_DELETED, StatusMessageColor.SUCCESS));
