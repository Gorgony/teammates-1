...
public class InstructorCourseRemindAction extends Action {
    ...
    public ActionResult execute() throws EntityDoesNotExistException {
        ...
        if (isSendingToStudent) {
            gateKeeper.verifyAccessible(
                    instructor, course, ParamNameConst.ParamsNames.INSTRUCTOR_PERMISSION_MODIFY_STUDENT);
        } else if (isSendingToInstructor) {
            gateKeeper.verifyAccessible(
                    instructor, course, ParamNameConst.ParamsNames.INSTRUCTOR_PERMISSION_MODIFY_INSTRUCTOR);
        } else {
        ...
        if (isSendingToStudent) {
            ...
            statusToUser.add(new StatusMessage(StatusMessageConst.StatusMessages.COURSE_REMINDER_SENT_TO + studentEmail,
            ...
            statusToUser.add(new StatusMessage(StatusMessageConst.StatusMessages.COURSE_REMINDER_SENT_TO + instructorEmail,
                                               StatusMessageColor.SUCCESS));
            ...
            statusToUser.add(new StatusMessage(StatusMessageConst.StatusMessages.COURSE_REMINDERS_SENT, StatusMessageColor.SUCCESS));
            redirectUrl = Const.ActionURIs.INSTRUCTOR_COURSE_DETAILS_PAGE;
        }
        ...
        response.addResponseParam(ParamNameConst.ParamsNames.COURSE_ID, courseId);
    ...
    private String extractStudentRegistrationKey(StudentAttributes student) {
        ...
        String keyParam = ParamNameConst.ParamsNames.REGKEY + "=";
