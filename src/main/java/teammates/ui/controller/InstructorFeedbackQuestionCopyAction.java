...
public class InstructorFeedbackQuestionCopyAction extends Action {
    ...
    protected ActionResult execute() {
        ...
        try {
            int index = 0;
            String feedbackQuestionId = getRequestParamValue(ParamNameConst.ParamsNames.FEEDBACK_QUESTION_ID + "-" + index);
            statusToAdmin = "";
            ...
            while (feedbackQuestionId != null) {
                ...
                feedbackQuestionId = getRequestParamValue(ParamNameConst.ParamsNames.FEEDBACK_QUESTION_ID + "-" + index);
            ...
            if (index > 0) {
                statusToUser.add(new StatusMessage(StatusMessageConst.StatusMessages.FEEDBACK_QUESTION_ADDED,
