...
public class AdminAccountManagementAccountTableRow {
    ...
    public String getInstructorHomePageViewLink() {
        ...
        link = Url.addParamToUrl(link, ParamNameConst.ParamsNames.USER_ID, account.googleId);
        return link;
    }
    ...
    public String getAdminViewAccountDetailsLink() {
        ...
        link = Url.addParamToUrl(link, ParamNameConst.ParamsNames.INSTRUCTOR_ID, account.googleId);
        return link;
    }
