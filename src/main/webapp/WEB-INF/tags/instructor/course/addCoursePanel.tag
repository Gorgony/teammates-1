...
<div class="panel panel-primary">
  <div class="panel-body fill-plain">
    <form method="get" action="<%=Const.ActionURIs.INSTRUCTOR_COURSE_ADD%>" name="form_addcourse" class="form form-horizontal">
      <input type="hidden" id="<%=ParamNameConst.ParamsNames.INSTRUCTOR_ID%>" name="<%=ParamNameConst.ParamsNames.INSTRUCTOR_ID%>" value="${googleId}">
      <input type="hidden" name="<%=ParamNameConst.ParamsNames.SESSION_TOKEN%>" value="${sessionToken}">
      <input type="hidden" name="<%=ParamNameConst.ParamsNames.USER_ID%>" value="${googleId}">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <select class="form-control"
              name="<%=ParamNameConst.ParamsNames.COURSE_TIME_ZONE%>"
              id="<%=ParamNameConst.ParamsNames.COURSE_TIME_ZONE%>"
