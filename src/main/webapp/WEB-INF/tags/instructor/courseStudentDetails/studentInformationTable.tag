...
<div class="well well-plain">
  <div class="form form-horizontal" id="studentInfomationTable">
    <div class="form-group">
      ...
      <div class="col-sm-11" id="<%=ParamNameConst.ParamsNames.STUDENT_NAME%>">
    ...
    <c:if test="${studentInfoTable.hasSection}">
      <div class="form-group">
        ...
        <div class="col-sm-11" id="<%= ParamNameConst.ParamsNames.SECTION_NAME %>">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-11" id="<%= ParamNameConst.ParamsNames.TEAM_NAME %>">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-11" id="<%= ParamNameConst.ParamsNames.STUDENT_EMAIL %>">
        <p class="form-control-static">${studentInfoTable.email}</p>
      </div>
    </div>
    <div class="form-group">
      <label class="col-sm-1 control-label">Comments:</label>
      <div class="col-sm-11" id="<%= ParamNameConst.ParamsNames.COMMENTS %>">
