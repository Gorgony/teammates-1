...
<div class="well well-plain" id="questionPreviewTable">
  <div class="row">
    ...
    <div class="col-xs-12 col-md-5 row tablet-margin-top-10px" data-toggle="tooltip" data-placement="top" title="<%= ToolTipConst.Tooltips.FEEDBACK_PREVIEW_ASSTUDENT %>">
      <form method="post" action="<%= Const.ActionURIs.INSTRUCTOR_FEEDBACK_PREVIEW_ASSTUDENT %>"
        ...
        <div class="col-sm-6">
          <select class="form-control margin-bottom-7px" name="<%= ParamNameConst.ParamsNames.PREVIEWAS %>">
        ...
        <input type="hidden" name="<%= ParamNameConst.ParamsNames.FEEDBACK_SESSION_NAME %>" value="${previewForm.fsName}">
        <input type="hidden" name="<%= ParamNameConst.ParamsNames.COURSE_ID %>" value="${previewForm.courseId}">
        <div class="col-sm-6">
    ...
    <div class="col-xs-12 col-md-5 row tablet-margin-top-10px" data-toggle="tooltip" data-placement="top" title="<%= ToolTipConst.Tooltips.FEEDBACK_PREVIEW_ASINSTRUCTOR %>">
