...
<%
  String startTimeString = (String)session.getAttribute(ParamNameConst.ParamsNames.FEEDBACK_SESSION_NOT_VISIBLE);
  session.removeAttribute(ParamNameConst.ParamsNames.FEEDBACK_SESSION_NOT_VISIBLE);
