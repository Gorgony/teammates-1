...
<div class="form-group">
  <label for="<%= ParamNameConst.ParamsNames.COPIED_FEEDBACK_SESSION_NAME %>" class="control-label">
    Name for copied sessions
  </label>
  <input class="form-control"
      id="<%= ParamNameConst.ParamsNames.COPIED_FEEDBACK_SESSION_NAME %>"
      type="text"
...
<c:forEach items="${data.courses}" var="course">
  <div class="checkbox">
    <label>
      <input type="checkbox"
          name="<%= ParamNameConst.ParamsNames.COPIED_COURSES_ID %>"
          value="${course.id}">
      <c:choose>
