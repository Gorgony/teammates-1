...
public class InstructorFeedbackQuestionAddActionTest extends BaseActionTest {
    ...
    public void testExecuteAndPostProcessMsq() {
        ...
        assertEquals(StatusMessageConst.StatusMessages.FEEDBACK_QUESTION_ADDED, result.getStatusMessage());
        ...
        params = new String[]{
                ...
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBER, "1",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE, "MSQ",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TEXT, "Who do you like in the class?",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_DESCRIPTION, "more details",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFCHOICECREATED, "2",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIESTYPE, "custom",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIES, "2",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_SHOWRESPONSESTO, FeedbackParticipantType.RECEIVER.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_SHOWGIVERTO, FeedbackParticipantType.RECEIVER.toString(),
        ...
        params = new String[]{
                ...
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_GIVERTYPE, FeedbackParticipantType.STUDENTS.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_RECIPIENTTYPE, FeedbackParticipantType.STUDENTS.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBER, "3",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE, "MSQ",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TEXT, "Choose all the food you like",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_DESCRIPTION, "more details",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFCHOICECREATED, "3",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_MSQCHOICE + "-0", "Pizza",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_MSQCHOICE + "-1", "Pasta",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_MSQCHOICE + "-2", "Chicken rice",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIESTYPE, "custom",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIES, "2",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_SHOWRESPONSESTO, FeedbackParticipantType.RECEIVER.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_SHOWGIVERTO, FeedbackParticipantType.RECEIVER.toString(),
                ...
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_EDITTYPE, "edit",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_GENERATEDOPTIONS, FeedbackParticipantType.NONE.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_MSQOTHEROPTIONFLAG, "on"
        };
    ...
    public void testExecuteAndPostProcessMcq() {
        ...
        params = new String[]{
                ...
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE, "MCQ",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TEXT, "Who do you like best in the class?",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_DESCRIPTION, "more details",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFCHOICECREATED, "2", // this field defaults to 2
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIESTYPE, "custom",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIES, "2",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_SHOWRESPONSESTO, FeedbackParticipantType.RECEIVER.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_SHOWGIVERTO, FeedbackParticipantType.RECEIVER.toString(),
        ...
        params = new String[]{
                ...
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBER, "3",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE, "MCQ",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TEXT, "What can be improved for this class?",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_DESCRIPTION, "more details",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFCHOICECREATED, "4",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_MCQCHOICE + "-0", "The content",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_MCQCHOICE + "-1", "Teaching style",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_MCQCHOICE + "-2", "Tutorial questions",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_MCQCHOICE + "-3", "Assignments",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIESTYPE, "custom",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIES, "2",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_SHOWRESPONSESTO, FeedbackParticipantType.RECEIVER.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_SHOWGIVERTO, FeedbackParticipantType.RECEIVER.toString(),
                ...
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_EDITTYPE, "edit",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_GENERATEDOPTIONS, FeedbackParticipantType.NONE.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_MCQOTHEROPTIONFLAG, "on"
        };
    ...
    public void testExecuteAndPostProcessNumScale() {
        ...
        String[] params = new String[]{
                ...
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TEXT, "Rate the class?",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_DESCRIPTION, "more details",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMSCALE_MIN, "1",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMSCALE_MAX, "5",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMSCALE_STEP, "0.5",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIESTYPE, "custom",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIES, "2",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_SHOWRESPONSESTO, FeedbackParticipantType.RECEIVER.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_SHOWGIVERTO, FeedbackParticipantType.RECEIVER.toString(),
    ...
    public void testExecuteAndPostProcessConstSumOption() {
        ...
        String[] params = new String[]{
                ...
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TEXT, "Split points among the options.",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_DESCRIPTION, "more details",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_CONSTSUMPOINTS, "30",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_CONSTSUMPOINTSFOREACHOPTION, "100",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_CONSTSUMPOINTSFOREACHRECIPIENT, "50",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_CONSTSUMPOINTSPEROPTION, "true",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFCHOICECREATED, "3",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_CONSTSUMOPTION + "-1", "Option 1",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_CONSTSUMOPTION + "-2", "Option 2",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_CONSTSUMOPTION + "-3", "Option 3",
    ...
    public void testExecuteAndPostProcessConstSumRecipient() {
        ...
        String[] params = new String[]{
                ...
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBER, "1",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE, "CONSTSUM",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TEXT, "Split points among students.",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_DESCRIPTION, "more details",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_CONSTSUMPOINTS, "30",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_CONSTSUMPOINTSFOREACHOPTION, "50",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_CONSTSUMPOINTSFOREACHRECIPIENT, "100",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_CONSTSUMPOINTSPEROPTION, "true",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_CONSTSUMTORECIPIENTS, "true",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFCHOICECREATED, "2", // default value.
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIESTYPE, "custom",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIES, "2",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_SHOWRESPONSESTO, FeedbackParticipantType.RECEIVER.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_SHOWGIVERTO, FeedbackParticipantType.RECEIVER.toString(),
    ...
    public void testExecuteAndPostProcessContributionQuestion() {
        ...
        String[] params = new String[]{
                ...
                ParamNameConst.ParamsNames.FEEDBACK_SESSION_NAME, fs.getFeedbackSessionName(),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_GIVERTYPE, FeedbackParticipantType.STUDENTS.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_RECIPIENTTYPE,
        ...
        assertEquals(FeedbackGuestionConst.FeedbackQuestion.CONTRIB_ERROR_INVALID_FEEDBACK_PATH
                     + "<br>" + StatusMessageConst.StatusMessages.FEEDBACK_QUESTION_ADDED,
    ...
    public void testExecuteAndPostProcessRubricQuestion() {
        ...
        String[] params = new String[]{
                ...
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_RUBRIC_SUBQUESTION + "-0", "SubQn-1",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_RUBRIC_CHOICE + "-0", "Choice-1",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_RUBRIC_WEIGHT + "-0", "-1",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_RUBRIC_SUBQUESTION + "-1", "SubQn-2",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_RUBRIC_CHOICE + "-1", "Choice-2",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_RUBRIC_WEIGHT + "-1", "2",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIESTYPE, "max",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIES, "1",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_SHOWRESPONSESTO, FeedbackParticipantType.INSTRUCTORS.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_SHOWGIVERTO, FeedbackParticipantType.INSTRUCTORS.toString(),
    ...
    public void testExecuteAndPostProcess() {
        ...
        modifyParamValue(params, ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TEXT, "");
        verifyAssumptionFailure(params);
        ...
        modifyParamValue(params, ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBER, "0");
        verifyAssumptionFailure(params);

        params = createParamsForTypicalFeedbackQuestion(fs.getCourseId(), fs.getFeedbackSessionName());
        // change questionNumber to invalid number
        modifyParamValue(params, ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBER, "-1");
        verifyAssumptionFailure(params);

        params = createParamsForTypicalFeedbackQuestion(fs.getCourseId(), fs.getFeedbackSessionName());
        // change questionNumber to invalid "number"
        modifyParamValue(params, ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBER, "ABC");
        ...
        modifyParamValue(params, ParamNameConst.ParamsNames.FEEDBACK_QUESTION_GIVERTYPE, "NON_EXISTENT_ENUMERATION");
        ...
        params = createParamsForTypicalFeedbackQuestion(instructor1ofCourse1.courseId, fs.getFeedbackSessionName());
        modifyParamValue(params, ParamNameConst.ParamsNames.FEEDBACK_QUESTION_RECIPIENTTYPE, "NON_EXISTENT_ENUMERATION");
        ...
        params = createParamsForTypicalFeedbackQuestion(instructor1ofCourse1.courseId, fs.getFeedbackSessionName());
        modifyParamValue(params, ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE, "NON_EXISTENT_ENUMERATION");
        ...
        modifyParamValue(params, ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMBEROFENTITIESTYPE, "max");
        InstructorFeedbackQuestionAddAction action = getAction(params);
        RedirectResult result = getRedirectResult(action);
        ...
        params = createParamsForTypicalFeedbackQuestion(fs.getCourseId(), fs.getFeedbackSessionName());
        modifyParamValue(params, ParamNameConst.ParamsNames.FEEDBACK_QUESTION_RECIPIENTTYPE, "TEAMS");
        ...
        params = createParamsForTypicalFeedbackQuestion(fs.getCourseId(), fs.getFeedbackSessionName());
        modifyParamValue(params, ParamNameConst.ParamsNames.FEEDBACK_QUESTION_RECIPIENTTYPE, "INSTRUCTORS");
        ...
        params = createParamsForTypicalFeedbackQuestion(fs.getCourseId(), fs.getFeedbackSessionName());
        modifyParamValue(params, ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TEXT, "attempted html injection '\"/>");
        ...
        params = createParamsForTypicalFeedbackQuestion(fs.getCourseId(), fs.getFeedbackSessionName());
        modifyParamValue(params, ParamNameConst.ParamsNames.FEEDBACK_QUESTION_SHOWGIVERTO, "");

        // Purposely not using modifyParamVale because we're removing showRecipientTo
        params[22] = ParamNameConst.ParamsNames.FEEDBACK_QUESTION_EDITTYPE;
        params[23] = "edit";
        ...
        params = createParamsForTypicalFeedbackQuestion(instructor1ofCourse1.courseId, fs.getFeedbackSessionName());
        modifyParamValue(params, ParamNameConst.ParamsNames.FEEDBACK_QUESTION_GIVERTYPE, "NONE");
        action = getAction(params);
        result = getRedirectResult(action);
