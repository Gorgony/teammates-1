...
public class StudentFeedbackSubmissionEditSaveActionTest extends BaseActionTest {
    ...
    public void testExecuteAndPostProcess() throws Exception {
        ...
        String[] submissionParams = new String[]{
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_RESPONSETOTAL + "-1", "1",
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_ID + "-1-0", fr.getId(),
                ParamNameConst.ParamsNames.FEEDBACK_SESSION_NAME, fr.feedbackSessionName,
                ParamNameConst.ParamsNames.COURSE_ID, fr.courseId,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_ID + "-1", fr.feedbackQuestionId,
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT + "-1-0", fr.recipient,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE + "-1", fr.feedbackQuestionType.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-1-0", "Edited" + fr.getResponseDetails().getAnswerString()
        };
        ...
        assertEquals(StatusMessageConst.StatusMessages.FEEDBACK_RESPONSES_SAVED, r.getStatusMessage());
        assertEquals(
        ...
        submissionParams = new String[]{
                ...
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT + "-1-0", fr.recipient,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE + "-1", fr.feedbackQuestionType.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-1-0", ""
        };
        ...
        submissionParams = new String[]{
                ...
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT + "-1-0", fr.recipient,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE + "-1", fr.feedbackQuestionType.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-1-0", "New " + fr.getResponseDetails().getAnswerString(),
                ParamNameConst.ParamsNames.SEND_SUBMISSION_EMAIL, "on"
        };
        ...
        submissionParams = new String[]{
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_RESPONSETOTAL + "-2", "1",
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_ID + "-2-0", fr.getId(),
                ParamNameConst.ParamsNames.FEEDBACK_SESSION_NAME, fr.feedbackSessionName,
                ParamNameConst.ParamsNames.COURSE_ID, fr.courseId,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_ID + "-2", fr.feedbackQuestionId,
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT + "-2-0", "",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE + "-2", fr.feedbackQuestionType.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-2-0", "Edited" + fr.getResponseDetails().getAnswerString(),
                ParamNameConst.ParamsNames.SEND_SUBMISSION_EMAIL, "on"
        };
        ...
        submissionParams = new String[]{
                ...
                ParamNameConst.ParamsNames.COURSE_ID, fr.courseId,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_ID + "-2", fr.feedbackQuestionId,
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT + "-2-0", fr.recipient,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE + "-2", fr.feedbackQuestionType.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-2-0", "",
                ParamNameConst.ParamsNames.SEND_SUBMISSION_EMAIL, "off"
        };
        ...
        submissionParams = new String[]{
                ...
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT + "-1-0", fr.recipient,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE + "-1", fr.feedbackQuestionType.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-1-0", "It's perfect"
        };
        ...
        submissionParams = new String[]{
                ...
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT + "-2-0", fr.recipient,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE + "-2", fr.feedbackQuestionType.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-2-0", "Tutorial",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_MCQ_ISOTHEROPTIONANSWER + "-2-0", "1"
        };
        ...
        submissionParams = new String[]{
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_RESPONSETOTAL + "-3", "1",
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_ID + "-3-0", fr.getId(),
                ParamNameConst.ParamsNames.FEEDBACK_SESSION_NAME, fr.feedbackSessionName,
                ParamNameConst.ParamsNames.COURSE_ID, fr.courseId,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_ID + "-3", fr.feedbackQuestionId,
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT + "-3-0", fr.recipient,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE + "-3", fr.feedbackQuestionType.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-3-0", "Pizza, Pasta, Chicken rice, Hotdog",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_MSQ_ISOTHEROPTIONANSWER + "-3-0", "1"
        };
        ...
        submissionParams = new String[]{
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_RESPONSETOTAL + "-3", "1",
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_ID + "-3-1", fr.getId(),
                ParamNameConst.ParamsNames.FEEDBACK_SESSION_NAME, fr.feedbackSessionName,
                ParamNameConst.ParamsNames.COURSE_ID, fr.courseId,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_ID + "-3", fr.feedbackQuestionId,
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT + "-3-1", fr.recipient,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE + "-3", fr.feedbackQuestionType.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-3-1", "Pasta",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_MSQ_ISOTHEROPTIONANSWER + "-3-1", "0"
        };
        ...
        submissionParams = new String[]{
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_RESPONSETOTAL + "-3", "1",
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_ID + "-3-2", fr.getId(),
                ParamNameConst.ParamsNames.FEEDBACK_SESSION_NAME, fr.feedbackSessionName,
                ParamNameConst.ParamsNames.COURSE_ID, fr.courseId,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_ID + "-3", fr.feedbackQuestionId,
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT + "-3-2", fr.recipient,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE + "-3", fr.feedbackQuestionType.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-3-2", "Hotdog",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_MSQ_ISOTHEROPTIONANSWER + "-3-2", "1"
        };
        ...
        submissionParams = new String[]{
                ...
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT + "-1-0", fr.recipient,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE + "-1", fr.feedbackQuestionType.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-1-0", "1",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMSCALE_MIN + "-1-0", Integer.toString(fqd.getMinScale()),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMSCALE_MAX + "-1-0", Integer.toString(fqd.getMaxScale()),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMSCALE_STEP + "-1-0", StringHelper.toDecimalFormatString(fqd.getStep())
        };
        ...
        submissionParams = new String[]{
                ...
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT + "-1-0", fr.recipient,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE + "-1", fr.feedbackQuestionType.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-1-0", "50",
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-1-0", "50",
        };
        ...
        submissionParams = new String[]{
                ...
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT + "-1-0", fr.recipient,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE + "-1", fr.feedbackQuestionType.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-1-0", "150",
        };
        ...
        submissionParams = new String[]{
                ParamNameConst.ParamsNames.COURSE_ID, dataBundle.feedbackResponses.get("response1ForQ1S1C1").courseId
        };
        ...
        submissionParams = new String[]{
                ...
                ParamNameConst.ParamsNames.COURSE_ID, fr.courseId,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_ID + "-1", fr.feedbackQuestionId,
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT + "-1-0", "invalid recipient",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE + "-1", fr.feedbackQuestionType.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-1-0", ""
        };
        ...
        submissionParams = new String[] {
                ...
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_ID + "-1", fr.feedbackQuestionId,
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT + "-1-0", fr.recipient,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE + "-1", "RUBRIC",
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-1-0", ""
        };
        ...
        assertEquals(
                getPageResultDestination(
                        ...
                        "FSQTT.idOfTypicalCourse1", "CONTRIB+Session"),
                r.getDestinationWithParams());
        assertEquals(String.format(StatusMessageConst.StatusMessages.FEEDBACK_RESPONSES_WRONG_QUESTION_TYPE, "1"), r.getStatusMessage());
        assertNull(frDb.getFeedbackResponse(fq.getId(), fr.giver, fr.recipient));
        ...
        submissionParams = new String[] {
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_RESPONSETOTAL + "-1", "1",
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_ID + "-1-0", otherFr.getId(),
                ParamNameConst.ParamsNames.FEEDBACK_SESSION_NAME, otherFr.feedbackSessionName,
                ParamNameConst.ParamsNames.COURSE_ID, otherFr.courseId,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_ID + "-1", otherFr.feedbackQuestionId,
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT + "-1-0", otherFr.recipient,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE + "-1", otherFr.feedbackQuestionType.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-1-0", ""
        };
        ...
        String[] validSubmissionParams = new String[]{
                ...
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT + "-1-0", fr.recipient,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE + "-1", fr.feedbackQuestionType.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-1-0", fr.getResponseDetails().getAnswerString(),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMSCALE_MIN + "-1-0", Integer.toString(fqd.getMinScale()),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMSCALE_MAX + "-1-0", Integer.toString(fqd.getMaxScale()),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMSCALE_STEP + "-1-0",
                        StringHelper.toDecimalFormatString(fqd.getStep()),
                ParamNameConst.ParamsNames.SEND_SUBMISSION_EMAIL, "on",

                ParamNameConst.ParamsNames.REGKEY, studentKey,
                ParamNameConst.ParamsNames.STUDENT_EMAIL, unregisteredStudent.email
        };
        ...
        assertEquals(StatusMessageConst.StatusMessages.FEEDBACK_RESPONSES_SAVED, redirectResult.getStatusMessage());
        gaeSimulation.logoutUser();
        ...
        String[] invalidSubmissionParams = new String[]{
                ...
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_RECIPIENT + "-1-0", fr.recipient,
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_TYPE + "-1", fr.feedbackQuestionType.toString(),
                ParamNameConst.ParamsNames.FEEDBACK_RESPONSE_TEXT + "-1-0", "100",
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMSCALE_MIN + "-1-0", Integer.toString(fqd.getMinScale()),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMSCALE_MAX + "-1-0", Integer.toString(fqd.getMaxScale()),
                ParamNameConst.ParamsNames.FEEDBACK_QUESTION_NUMSCALE_STEP + "-1-0",
                        StringHelper.toDecimalFormatString(fqd.getStep()),
    ...
    protected String getPageResultDestination(
        ...
        String pageDestination = parentUri;
        pageDestination = addParamToUrl(pageDestination, ParamNameConst.ParamsNames.STUDENT_EMAIL, studentEmail);
        pageDestination = addParamToUrl(pageDestination, ParamNameConst.ParamsNames.ERROR, Boolean.toString(isError));
        pageDestination = addParamToUrl(pageDestination, ParamNameConst.ParamsNames.COURSE_ID, courseId);
        pageDestination = addParamToUrl(pageDestination, ParamNameConst.ParamsNames.FEEDBACK_SESSION_NAME, fsname);
