...
public class StudentFeedbackSubmitPageUiTest extends BaseUiTestCase {
    ...
    private void testSubmitAction() throws Exception {
        ...
        submitPage.verifyStatus(String.format(StatusMessageConst.StatusMessages.FEEDBACK_RESPONSES_MSQ_MIN_CHECK, qnNumber, 2));
        ...
        submitPage.clickSubmitButton();
        submitPage.verifyStatus(String.format(StatusMessageConst.StatusMessages.FEEDBACK_RESPONSES_MSQ_MAX_CHECK, qnNumber, 3));
        ...
        submitPage.clickSubmitButton();
        submitPage.verifyStatus(String.format(StatusMessageConst.StatusMessages.FEEDBACK_RESPONSES_MSQ_MIN_CHECK, qnNumber, 3));
